...

{
  ...
  # PLACEHOLDER: Replace this with actual hardware scan results
  ...
  # PLACEHOLDER: Update these filesystem paths based on actual system
  fileSystems."/" =
  ...
  # PLACEHOLDER: Add swap configuration if needed
  # swapDevices =
